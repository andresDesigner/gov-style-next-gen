    ...
    >
      <div className="mx-auto grid max-w-[1200px] grid-cols-12 gap-8 px-6 py-20">
        ...
        <div className="col-span-12 flex flex-col justify-end gap-3 lg:col-span-4 lg:items-end">
          <a
            href="/#book"
            className="btn-gov inline-flex items-center justify-center gap-2 bg-accent px-6 py-3 text-center text-sm font-semibold text-accent-foreground transition-colors hover:bg-accent/90"
          >
          ...
          <a
            href={secondaryHref}
            className="btn-gov inline-flex items-center justify-center gap-2 border-[1.5px] border-primary-foreground/90 px-6 py-3 text-center text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-foreground/10"
          >
