...
function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Skip link — visible on focus (brief §12) */}
      <a
        href="#main"
        ...
        <div className="mx-auto grid max-w-[1200px] grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-6 py-4 sm:h-16 sm:grid-cols-none sm:flex sm:flex-wrap sm:justify-between">
          <div className="flex min-w-0 items-center gap-8">
            ...
            <ul className="hidden lg:flex gap-6 text-sm font-medium">
              {["Services", "How We Verify", "For Government", "Resources", "About"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
          ...
          <a
            href="#book"
            className="btn-gov shrink-0 bg-foreground px-4 py-2.5 text-sm font-medium text-background transition-colors hover:bg-primary"
          >
      ...
      <main id="main">
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-12 gap-8 px-6 py-16 lg:py-24">
            <div className="col-span-12 lg:col-span-8">
              ...
              <div className="mt-10 flex flex-wrap gap-3">
                <a
                  href="#book"
                  className="btn-gov bg-foreground px-5 py-3 text-sm font-medium text-background transition-colors hover:bg-primary"
                >
                  Book a Readiness Call
                </a>
                <a
                  href="#capability"
                  className="btn-gov border border-foreground/25 px-5 py-3 text-sm font-medium text-foreground transition-colors hover:border-foreground hover:bg-foreground/[0.03]"
                >
            ...
            >
              <div className="border border-foreground/10 bg-card p-6 shadow-[0_1px_0_0_theme(colors.foreground/8%)]">
                <div className="mb-4 font-mono text-[10px] uppercase tracking-widest text-foreground/50">
                  Compliance Deadlines · ADA.gov
                </div>
                <dl className="divide-y divide-foreground/10">
                  <div className="pb-4">
                    <div className="flex items-baseline justify-between">
                      <dt className="font-mono text-sm font-medium tabular-nums text-foreground">
                        April 26, 2027
                      </dt>
                      <span className="bg-primary/10 px-1.5 py-0.5 font-mono text-[10px] tracking-widest text-primary">
                        PHASE 1
                      </span>
                    </div>
                    <dd className="mt-1 text-xs uppercase tracking-wide text-foreground/60">
                  ...
                  <div className="pt-4">
                    <div className="flex items-baseline justify-between">
                      ...
                      <span className="bg-foreground/5 px-1.5 py-0.5 font-mono text-[10px] tracking-widest text-foreground/60">
                        PHASE 2
                      </span>
                    </div>
                    <dd className="mt-1 text-xs uppercase tracking-wide text-foreground/60">
        ...
        <section aria-label="Firm credentials" className="bg-foreground text-background">
          <div className="mx-auto flex max-w-[1200px] flex-wrap items-center justify-between gap-x-10 gap-y-3 px-6 py-4">
            {[
              "Section 508 Trusted Tester-led practice",
              "10+ years in accessibility compliance",
              "AI-assisted · human-verified",
            ].map((label) => (
              <div key={label} className="flex items-center gap-3">
                <span aria-hidden="true" className="h-2 w-2 bg-accent" />
                <span className="font-mono text-[10px] uppercase tracking-wider text-background/85">
                  {label}
                </span>
              </div>
            ))}
        ...
        {/* Engagement stepper */}
        <section aria-labelledby="engagement" className="border-b border-foreground/10">
          <div className="mx-auto max-w-[1200px] px-6 pt-16">
            <div className="mb-8 flex items-baseline justify-between">
              <div>
                <div className="font-mono text-[10px] uppercase tracking-widest text-foreground/50">
                  Engagement Model · 6 phases
                </div>
                <h2 id="engagement" className="mt-2 text-2xl font-medium tracking-tight md:text-3xl">
          ...
          <div className="mx-auto max-w-[1200px]">
            <ol className="grid grid-cols-2 border-l border-foreground/10 md:grid-cols-3 lg:grid-cols-6">
              {engagement.map((step, i) => (
                <li
                  key={step.n}
                  className={`border-r border-b border-foreground/10 p-6 ${
                    i === 0 ? "bg-card" : ""
                  }`}
                >
                  <div
        ...
        {/* Deadline reality */}
        <section aria-labelledby="deadline-reality" className="border-b border-foreground/10">
          <div className="mx-auto grid max-w-[1200px] grid-cols-12 gap-8 px-6 py-24">
            <div className="col-span-12 lg:col-span-5">
              ...
              <h2
                id="deadline-reality"
                className="mt-3 text-balance text-3xl font-medium leading-tight tracking-tight md:text-4xl"
              >
              ...
              <div className="mt-6 border-l-2 border-primary bg-secondary/60 px-6 py-3 font-mono text-[11px] leading-relaxed text-foreground/70">
                Last reviewed: 2026-07-16 · Informational, not legal advice.
                <br />
            ...
            <div className="col-span-12 lg:col-span-7">
                ...
                {[
                  {
                    label: "Standard",
                    value: "WCAG 2.1 AA",
                    note: "Mandatory baseline for all digital assets under Title II.",
                  },
                  {
                    label: "Runway",
                    value: "≈ 9 mo",
                    note: "From today to the Phase 1 deadline of April 26, 2027.",
                  },
                  {
                    label: "Coverage",
                    value: "Web · App · PDF",
                    note: "Third-party content and vendor platforms included.",
                  },
                  {
                    label: "Evidence",
                    value: "Behavioral",
                    note: "Native screen-reader verification, not scanner-only.",
                  },
                ].map((cell) => (
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  href="#"
                  className="border border-primary/40 px-4 py-2 font-mono text-[11px] uppercase tracking-wider text-primary hover:bg-primary/5"
                >
        ...
        {/* Service cards 4 + 2 */}
        <section aria-labelledby="services" className="border-b border-foreground/10 bg-secondary/30">
          <div className="mx-auto max-w-[1200px] px-6 py-24">
            <div className="mb-10 flex flex-wrap items-baseline justify-between gap-6">
              <div>
                <div className="font-mono text-[10px] uppercase tracking-widest text-foreground/50">
                  Services · 4 primary + 2 Phase 2
                </div>
                <h2
                  id="services"
              ...
              <a
                href="#"
                className="font-mono text-[11px] uppercase tracking-wider text-primary hover:underline underline-offset-4 decoration-2"
              >
                All services →
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 gap-px border border-foreground/10 bg-foreground/10 md:grid-cols-2 lg:grid-cols-4">
              {primaryServices.map((s) => (
                <article key={s.id} className="group bg-card p-6">
                  <div className="mb-4 font-mono text-[10px] tracking-widest text-primary">
                    {s.id}
                  </div>
                  ...
                  <a
                    href="#"
                    className="mt-6 inline-block font-mono text-[11px] uppercase tracking-wider text-primary decoration-1 underline-offset-4 transition-[text-decoration-thickness] hover:underline hover:decoration-2"
                  >
                    Learn more →
                  </a>
                </article>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              {secondaryServices.map((s) => (
                <article
                  key={s.id}
                  className="border border-dashed border-foreground/25 bg-background p-6"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="mb-2 font-mono text-[10px] tracking-widest text-foreground/50">
                        {s.id}
                      </div>
                      <h3 className="text-lg font-semibold">{s.title}</h3>
                    </div>
                    <span className="shrink-0 border border-foreground/15 px-2 py-0.5 font-mono text-[10px] uppercase tracking-widest text-foreground/50">
                      Phase 2
                    </span>
                  </div>
        ...
        {/* Methodology preview + Who we help */}
...
status      confirmed · defensible`}
              ...
              <a
                href="#"
                className="mt-6 inline-block font-mono text-[11px] uppercase tracking-wider text-primary hover:underline underline-offset-4 decoration-2"
              >
                See how we verify →
              </a>
            </div>
            ...
            >
              ...
              <h3 id="audience" className="mt-2 text-2xl font-medium tracking-tight">
              ...
              <a
                ...
                className="mt-6 inline-block font-mono text-[11px] uppercase tracking-wider text-primary hover:underline underline-offset-4 decoration-2"
              >
                Visit For Government →
              </a>
            </aside>
          </div>
        </section>

        {/* Operations / Trust triptych */}
        <section aria-labelledby="operations" className="border-b border-foreground/10">
          <div className="mx-auto max-w-[1200px] px-6 py-24">
            <div className="mb-10">
              <div className="font-mono text-[10px] uppercase tracking-widest text-foreground/50">
                Operations · Capability Statement
              </div>
              <h2 id="operations" className="mt-2 text-3xl font-medium tracking-tight">
        ...
        {/* Final CTA band */}
        <section id="book" aria-labelledby="cta" className="bg-foreground text-background">
          <div className="mx-auto grid max-w-[1200px] grid-cols-12 gap-8 px-6 py-20">
            <div className="col-span-12 lg:col-span-8">
              ...
              <p className="mt-4 max-w-[52ch] text-base text-background/70">
            ...
            <div className="col-span-12 flex flex-col justify-end gap-3 lg:col-span-4 lg:items-end">
              <a
                href="#"
                className="btn-gov bg-background px-6 py-3 text-center text-sm font-medium text-foreground transition-colors hover:bg-secondary"
              >
                Book a Readiness Call
              </a>
              <a
                id="capability"
                href="#"
                className="btn-gov border border-background/30 px-6 py-3 text-center text-sm font-medium text-background transition-colors hover:bg-background/10"
              >
                Download Capability Statement
              </a>
            </div>
